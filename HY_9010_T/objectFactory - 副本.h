...
namespace demo {
	...
	class MyObject : public node::ObjectWrap {
	 ...
	 private:
		  ...
		  static void captureview(void *arg);
		 
		  static void sysInfoHandle(void *arg);
		  static void sysCmdHandle(void *arg);
	...
	private:
		...
		static void usartCallback(char data);
		static void usartgpsCallback(char data);
	private:
	...
	private:
		...
		static CSerialPort *m_gpsSerial;
		static CSerialPort *m_Serial;
